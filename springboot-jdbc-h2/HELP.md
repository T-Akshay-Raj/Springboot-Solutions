...
* The original package name 'com.example.springboot.jdbc.springboot-jdbc-h2' is invalid and this project uses 'com.example.springboot.jdbc.springbootjdbch2' instead.
