...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), '2024-04-07');
