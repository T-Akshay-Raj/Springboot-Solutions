...
* The original package name 'com.springboot.jpa-postgres.Springboot Postgres' is invalid and this project uses 'com.springboot.jpapostgres.Springboot.Postgres' instead.
